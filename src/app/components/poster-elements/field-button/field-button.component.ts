...
@Component({
  ...
  template: `
    <button cdkDrag [cdkDragData]="field()" class="w-full p-3 border border-gray-200 hover:border-black hover:shadow-md transition-shadow rounded-lg flex items-center gap-3 cursor-pointer">
